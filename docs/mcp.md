...
## 실제 확인 (2026-09-23, Base Sepolia)

MCP 지갑 `0x06578002e67Ec357Bf1932c97de5f6053AD60990`이 Bazaar에서 찾은 **외부 판매자** `GET https://www.getbags.app/api/v1`을 0.01 USDC에 구매해 결과(JSON)를 받았습니다. tx [`0xd02557b8…6279df`](https://sepolia.basescan.org/tx/0xd02557b808ed70e8533e153bcfb132d3ead8c6e931cb13e43f1936359e6279df). 위임 0.06 USDC, 건당 0.02 USDC 안에서 실행됐고, 같은 세션에서 다른 판매자(`intel.rallylive.ca`) 3건은 서명 뒤 판매자 측 402로 실패해 0.001 USDC씩 예약만 소비됐습니다. 판매자 쪽 실패도 예산에서 빠진다는 점이 그대로 드러난 사례입니다. 메인넷 실구매는 아직 하지 않았습니다.
